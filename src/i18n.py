    ...
    def __init__(self, lang='ko'):
        ...
        self.translations = {
            'ko': {
                ...
                'bring_to_front': '맨 앞으로 가져오기',
                'send_to_back': '맨 뒤로 보내기',
                'changed_color_objs': '{count}개 객체의 색상을 변경했습니다.',
                'processing_pixels': '{count}개 픽셀 처리 중...',
                'objects_created': '{count}개 객체 생성됨',
                'image_files': '이미지 파일',
                'all_files': '모든 파일',
                'import_image_title': '이미지 가져오기',
                'loading_image': '이미지 불러오는 중',
                'converting': '변환 중',
                'resizing': '크기 조정 중',
                'tracing_pixels': '픽셀 추적 중',
                'creating_group': '그룹 생성 중',
                'import_error': '가져오기 오류',
                'failed_import': '이미지를 가져오지 못했습니다',
                ...
                'change_color': '색상 변경',
                'layer_info': '레이어: {name}',
                'language_changed': '언어로 변경되었습니다: 한국어',
            ...
            'en': {
                ...
                'send_to_back': 'Send to Back',
                'changed_color_objs': 'Changed color of {count} objects.',
                'processing_pixels': 'Processing {count} pixels...',
                'objects_created': '{count} objects created',
                ...
                'resizing': 'Resizing',
                'tracing_pixels': 'Tracing Pixels',
                'creating_group': 'Creating Group',
                'import_error': 'Import Error',
                'failed_import': 'Failed to import image',
